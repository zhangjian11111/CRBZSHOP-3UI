...
let PC_URL = (process.env.NODE_ENV === 'development' ? BASE.PC_SDEV_URL : BASE.PC_SPROD_URL)
let WAP_URL = (process.env.NODE_ENV === 'development' ? BASE.WAP_SDEV_URL : BASE.WAP_SPROD_URL)
